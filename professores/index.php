...
$sql = "SELECT * FROM professores ORDER BY nome_professor ASC";
                ...
                <?php while ($professor = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td class="table-actions">
                            <a href="visualizar.php?id=<?php echo $professor['id_professor']; ?>" class="btn btn-secondary btn-small">👁️ Ver</a>
                            <?php if (isProprietario()): ?>
                                <a href="editar.php?id=<?php echo $professor['id_professor']; ?>" class="btn btn-primary btn-small">✏️ Editar</a>
                                <a href="excluir.php?id=<?php echo $professor['id_professor']; ?>" class="btn btn-danger btn-small" onclick="return confirm('Tem certeza que deseja excluir este professor?')">🗑️ Excluir</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endwhile; ?>
